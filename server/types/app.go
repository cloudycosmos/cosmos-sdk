...
type (
	...
	AppCreator func(string, log.Logger, dbm.DB, io.Writer, AppOptions) Application
	...
	AppExporter func(string, log.Logger, dbm.DB, io.Writer, int64, bool, []string, AppOptions) (ExportedApp, error)
)
