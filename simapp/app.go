...
func NewSimApp(
	...
	chainID := "fake-chain-id-199"  // YITODO: need a better way to get chainID
	bApp := baseapp.NewBaseApp(appName, logger, db, encodingConfig.TxConfig.TxDecoder(), chainID, baseAppOptions...)
